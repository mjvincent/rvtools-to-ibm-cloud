...
API/database issue. Carbon Export Readiness includes handoff guidance that
explains key package controls, generated files, primary owners, and the boundary
that Terraform execution remains outside the app.
