...
fix context and filtered by severity, with active filter chips and a clear
action, before they are grouped by severity and category. When backend preflight
