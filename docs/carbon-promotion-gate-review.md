...
inventory constants. Carbon UI performance coverage now includes generated
5,000-row VM Assignment search/sort and VM Overrides missing-reason filtering
guards.
