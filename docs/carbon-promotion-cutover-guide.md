...
8. Execute the [Carbon Manual UAT Runbook](carbon-manual-uat-runbook.md), complete the [Carbon Accessibility and UAT Checklist](carbon-accessibility-uat-checklist.md) for the release candidate, record the decision in the [Carbon Accessibility and UAT Results Template](carbon-accessibility-uat-results-template.md), and attach evidence to the promotion review.
