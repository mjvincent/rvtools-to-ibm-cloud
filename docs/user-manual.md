...
- **Completion checklists**: Each main Carbon workflow shows a compact `Complete when` checklist below the header so users can see the finish criteria without opening help.
