...
20. Search or filter package preflight findings when needed, then review grouped findings by severity and category, starting with blockers; expand the full list when additional findings are hidden.
