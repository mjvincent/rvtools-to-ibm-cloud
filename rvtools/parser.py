...
from .storage import build_storage_inventory
...
def parse_rvtools_workbook(
    ...
    # 4. STORAGE SUMMARY
    storage_inventory = build_storage_inventory(df_vdisk, df_vpartition)
    partitions_by_vm = storage_inventory.partitions_by_vm
    disk_sum = storage_inventory.disk_sum
    disk_count = storage_inventory.disk_count
    boot_disk_gb = storage_inventory.boot_disk_gb
    disk_details = storage_inventory.disk_details
    unmatched_partition_details = (
        storage_inventory.unmatched_partition_details
    )
