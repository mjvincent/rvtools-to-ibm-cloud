    ...
    for vm in vms:
        ...
        if not connected:
            findings.append(PreflightFinding(
                ...
                "Connect at least one NIC in source data, re-export RVTools, or exclude the VM.",
                "Source RVTools/vSphere data or VM Review > Exclude?",
                "Connect at least one source NIC with a valid network/port group, re-export RVTools, or exclude this VM from this package.",
